...
# ignoring low-data languages (as per the criterion used in Table 6).


prepare_data_ignore_low <- function(infile = "../data/verbal_roots_download.tsv",
                                    outfile = "../data/prepared_nolow.RData") {
  file_contents <- read_data(infile)

  file_contents <- ignore_low_data(file_contents)
